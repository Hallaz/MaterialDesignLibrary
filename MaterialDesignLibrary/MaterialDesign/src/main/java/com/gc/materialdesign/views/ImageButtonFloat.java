 ...
 */
public class ImageButtonFloat extends Button {
    ...
    public ImageButtonFloat(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//		super.setDefaultProperties();
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        post(new Runnable() {
            ...
            @Override
            public void run() {
                showPosition = ViewHelper.getY(ImageButtonFloat.this) - Utils.dpToPx(24, getResources());
                hidePosition = ViewHelper.getY(ImageButtonFloat.this) + getHeight() * 3;
                if (animate) {
                    ViewHelper.setY(ImageButtonFloat.this, hidePosition);
                    show();
                }
            }
        });
    ...
    public void show() {
        ObjectAnimator animator = ObjectAnimator.ofFloat(ImageButtonFloat.this, "y", showPosition);
    ...
    public void hide() {
        ...
        ObjectAnimator animator = ObjectAnimator.ofFloat(ImageButtonFloat.this, "y", hidePosition);
        animator.setInterpolator(new BounceInterpolator());
        animator.setDuration(1500);
        animator.start();
