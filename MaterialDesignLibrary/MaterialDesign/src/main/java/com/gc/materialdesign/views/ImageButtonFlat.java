 ...
 */
public class ImageButtonFlat extends Button {
    ...
    public ImageButtonFlat(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(Utils.dpToPx(sizeIcon, getResources()), Utils.dpToPx(sizeIcon,
                getResources()));
    ...
    protected void setDefaultProperties() {
        ...
        super.background = R.drawable.background_transparent;
//		super.setDefaultProperties();
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        post(new Runnable() {
            ...
            @Override
            public void run() {
                showPosition = ViewHelper.getY(ImageButtonFlat.this) - Utils.dpToPx(24, getResources());
                hidePosition = ViewHelper.getY(ImageButtonFlat.this) + getHeight() * 3;
                if (animate) {
                    ViewHelper.setY(ImageButtonFlat.this, hidePosition);
                    show();
                }
            }
        });
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (x != -1) {
            ...
            Rect dst = new Rect(Utils.dpToPx(6, getResources()), Utils.dpToPx(6, getResources()), getWidth() - Utils.dpToPx(6, getResources()),
    ...
    public void show() {
        ObjectAnimator animator = ObjectAnimator.ofFloat(ImageButtonFlat.this, "y", showPosition);
    ...
    public void hide() {
        ...
        ObjectAnimator animator = ObjectAnimator.ofFloat(ImageButtonFlat.this, "y", hidePosition);
        animator.setInterpolator(new BounceInterpolator());
        animator.setDuration(1500);
        animator.start();
