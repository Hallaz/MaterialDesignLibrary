...
```xml
<com.gc.materialdesign.views.ImageButtonFlat
...
```xml
<com.gc.materialdesign.views.ImageButtonFloat
...
```xml
<com.gc.materialdesign.views.ButtonFlatVertical
...
```xml
<com.gc.materialdesign.views.ButtonVertical
